...
public class reptile extends Animal{
    public String species = "Bò Sát";// giống loài

    public reptile() {
    }

    public reptile(String name, double size, String color, String living_enviroment, String personality, String food, String conservation, String species) {
    ...
    void gioithieu() {
        ...
        System.out.print("_ "+name +" là một loài động thuộc họ Bò Sát. Kích thước " + size + " cùng với màu "+ color+" đặc trưng. "+
