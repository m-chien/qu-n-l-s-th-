...
public class bird extends Animal{
    public String species = "Chim";// giống loài

    public bird() {
    }

    public bird(String name, double size, String color, String living_enviroment, String personality, String food, String conservation, String species) {
    ...
    void gioithieu() {
        ...
        System.out.print("_ "+name +" là một loài động thuộc họ Chim. Kích thước " + size + " cùng với màu "+ color+" đặc trưng. "+
